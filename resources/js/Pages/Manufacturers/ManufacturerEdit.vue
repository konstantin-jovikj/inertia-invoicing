<script setup>
    ...
    const form = useForm({
        ...
        place_id: props.manufacturer.place_id,
        country_id: props.manufacturer.place.country_id,
        address: props.manufacturer.address,
            ...
            <div class="mx-auto max-w-11/12 sm:px-6 lg:px-8">
                <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900">
                        <form
                            @submit.prevent="form.put('/manufacturer/update/' + form.id, {
                            onError: () => form.reset()
                        })">
