                                    ...
                                    <div class="lg:col-span-2">
                                        ...
                                        <div class="grid grid-cols-1 gap-4 text-sm gap-y-2 md:grid-cols-6">
                                            ...
                                            <div class="py-4 mb-4 border-b border-gray-200 md:col-span-1">
                                                ...
                                                <input type="checkbox" v-model="form.is_for_export" id="is_for_export"
                                            ...
                                            <!-- Is For Translation -->
                                            <div class="py-4 mb-4 border-b border-gray-200 md:col-span-1">
                                                <InputLabel for="is_translation">Дали е потребен
                                                    Превод?</InputLabel>
                                            ...
                                            <!-- DDV -->
                                            <div class="md:col-span-2">
                                                <InputLabel for="tax_id">Избери ДДВ
                                                    Стапка</InputLabel>
                                            ...
                                            <!-- Terms -->
                                            <div class="md:col-span-2">
                                                <InputLabel for="term_id">Услови за
                                                    плаќање</InputLabel>
                                            ...
                                            <!-- IncoTerms -->
                                            <div class="md:col-span-2">
                                                <InputLabel for="incoterm_id">Испорака /
                                                    Паритет</InputLabel>
                                                ...
                                                <div class="flex items-center gap-2">
                                                    <TextInput
                                                        v-model="
                                                            form.advance_payment
                                                        "
                                                        type="number" step="0.01" id="advance_payment"
                                                        class="w-full h-10 px-4 mt-1 text-sm border rounded bg-gray-50" />
                                                    <span
