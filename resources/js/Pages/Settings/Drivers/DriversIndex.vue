...
const deleteDriver = (id) => {
    if (confirm("Дали сигурно сакаш да го избришеш овој Возач?")) {
        router.delete("/drivers/delete/" + id, {
            preserveState: false,
            onSuccess: () => {
                ...
                <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900">
                        <div class="flex justify-between mb-4">
                            <h2 class="font-bold text-sky-800">Возачи</h2>
                            <div class="flex">
                                <Link
                                    v-tippy="{
                                        content: 'Додај Нов Возач',
                                        arrow: true,
                                        theme: 'light',
                                    }"
                                    href="drivers/add"
                        ...
                        >
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                >
                                    ...
                                    <td class="">{{ driver.surname }}</td>
                                    <td class="">{{ driver.licence_no }}</td>
                                    <td class="">{{ driver.personal_id_no }}</td>
                        ...
                        >
                            ...
                            <p class="mt-3 text-xs text-gray-500">
                                Прикажани се од {{ drivers.from }} до
                                {{ drivers.to }} од вкупно
                                {{ drivers.total }} записи
                            </p>
                        </div>
                    </div>
                </div>
