...
const form = useForm({
    directive: props.directive.directive,
    description: props.directive.description,
});
            ...
            <div class="mx-auto max-w-11/12 sm:px-6 lg:px-8">
                <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900">
                        <form @submit.prevent="form.put('/directive/update/' + directive.id, {
                            onError: () => form.reset()
                        })">
                            <div
                                ...
                                >
                                    <div class="text-gray-600">
                                        <p class="text-lg font-medium">
                                            Додај Нова Директива
                                        </p>
                                        <p>
                                            Внеси го името и Описот на
                                            Директивата
                                        </p>
                                    </div>
                                    ...
                                    <div class="lg:col-span-2">
                                        ...
                                        >
                                            <div class="md:col-span-6">
                                                <InputLabel for="directive"
                                                    >Име на
                                                    Директива</InputLabel
                                                >

                                                <TextInput
                                                    v-model="form.directive"
                                                    type="text"
                                                    id="directive"
